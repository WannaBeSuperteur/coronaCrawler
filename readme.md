<strong> 2020년 07월 20일부터 질병관리청 발표 양식이 변경되어 질병관리청 보도자료에서 공개되지 않는 정보는 0으로 표시되는 점 양해 부탁드립니다.</strong>
...
<strong>[주의사항] 질병관리청 보도자료의 양식이 계속 일정하지 않은 경우, 최신 데이터를 크롤링한 결과가 질병관리청 자료의 데이터와 다를 수 있음</strong>
