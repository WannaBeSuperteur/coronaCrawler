...
for i in range(len(linkList)): # list.txt 파일에 있는 각 질병관리청 보도자료 링크에 있는 자료에 대하여 
    ...
    print(valueList[80:100])
    print(valueList[100:])

    if int(time) >= 20072000: # 2020.07.20 00시 이후의 data 이면
        if time == '21030900': # 2021.03.09 00시의 data 이면
            ...
            val2 = valueList[93]
            val3 = valueList[95]
        elif time == '21030500' or time == '21031000':
            val0 = valueList[38] + valueList[68]
            val1 = valueList[90]
            val2 = valueList[91]
            val3 = valueList[93]
            ...
            val2 = valueList[94]
            val3 = valueList[96]
        elif time == '21012100' or time == '21012300' or time == '21012500' or time == '21020800' or time == '21021400' or time == '21021700':
            val0 = int(valueList[38]) + valueList[67]
            val1 = valueList[98]
            val2 = valueList[99]
            val3 = valueList[101]
        elif (time == '21011400' or time == '21011600' or time == '21012700' or time == '21013100' or time == '21020200' or
              time == '21020600' or time == '21021800' or time == '21022500' or time == '21022800'):
            val0 = int(valueList[38]) + valueList[67]
            val1 = valueList[97]
            val2 = valueList[98]
            val3 = valueList[100]
            ...
            val2 = valueList[102]
            val3 = valueList[104]
        elif time == '20120800' or time == '20121500' or time == '20122600' or time == '21010100' or time == '21010400' or time == '21022400':
            val0 = valueList[38] + valueList[67]
            val1 = valueList[95]
            val2 = valueList[96]
            val3 = valueList[98]
              ...
              time == '21020500' or time == '21021600' or time == '21022300'):
            val0 = int(valueList[38]) + valueList[67]
            val1 = valueList[96]
            val2 = valueList[97]
            val3 = valueList[99]
            ...
            val3 = valueList[93]
              ...
              time == '21021900' or time == '21022100' or time == '21022200'):
            val0 = int(valueList[38]) + valueList[67]
            val1 = valueList[94]
            val2 = valueList[95]
            val3 = valueList[97]
            ...
            val2 = valueList[100]
            val3 = valueList[102]
        elif time == '20111900' or time == '21010200' or time == '21011500' or time == '21012600' or time == '21030600':
            val0 = valueList[38] + valueList[67]
            val1 = valueList[92]
            val2 = valueList[93]
            val3 = valueList[95]
            ...
            val3 = valueList[98]
              ...
              time == '21021200' or time == '21021500' or time == '21030300' or time == '21030400'):
            val0 = int(valueList[38]) + valueList[67]
            val1 = valueList[93]
            val2 = valueList[94]
            val3 = valueList[96]
