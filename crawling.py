...
for i in range(len(linkList)): # list.txt 파일에 있는 각 질병관리청 보도자료 링크에 있는 자료에 대하여 
    ...
    if int(time) >= 20072000: # 2020.07.20 00시 이후의 data 이면
        if time == '21012200': # 2021.01.22 00시의 data 이면
            val0 = int(valueList[38]) * 10000 + int(valueList[39]) + valueList[68]
            val1 = valueList[93]
            val2 = valueList[94]
            val3 = valueList[96]
        elif time == '21012100' or time == '21012300' or time == '21012500':
            val0 = int(valueList[38]) + valueList[67]
            val1 = valueList[98]
            val2 = valueList[99]
            val3 = valueList[101]
        elif time == '21011400' or time == '21011600' or time == '21012700' or time == '21013100':
            val0 = int(valueList[38]) + valueList[67]
            val1 = valueList[97]
            val2 = valueList[98]
            val3 = valueList[100]
            ...
            val2 = valueList[106]
            val3 = valueList[108]
        elif time == '21010500' or time == '21013000':
            ...
            val2 = valueList[95]
            val3 = valueList[97]
        elif time == '20121800': # 2020.12.18 00시의 data 이면
            val0 = valueList[38] + valueList[67]
            val1 = valueList[89]
            val2 = valueList[90]
            val3 = valueList[92]
        elif time == '20121100' or time == '20122200':
            val0 = int(valueList[38]) + valueList[67]
            val1 = valueList[99]
            val2 = valueList[100]
            val3 = valueList[102]
        elif time == '20121000': # 2020.12.10 00시의 data 이면
            val0 = int(valueList[38]) + valueList[67]
            val1 = valueList[101]
            val2 = valueList[102]
            val3 = valueList[104]
        elif time == '20120800' or time == '20121500' or time == '20122600' or time == '21010100' or time == '21010400':
            val0 = valueList[38] + valueList[67]
            val1 = valueList[95]
            val2 = valueList[96]
            val3 = valueList[98]
        elif (time == '20120700' or time == '20120900' or time == '20121600' or time == '20123000' or time == '21010700' or
              time == '21010800' or time == '21011100' or time == '21011800' or time == '21011900'):
            val0 = int(valueList[38]) + valueList[67]
            val1 = valueList[96]
            val2 = valueList[97]
            val3 = valueList[99]
            ...
            val2 = valueList[94]
            val3 = valueList[96]
        elif time == '20120400' or time == '20122700' or time == '21011200' or time == '21012400' or time == '21012900':
            val0 = valueList[38] + valueList[67]
            val1 = valueList[90]
            val2 = valueList[91]
            val3 = valueList[93]
        elif (time == '20120200' or time == '20120600' or time == '20122100' or time == '20122300' or time == '20122800' or
              time == '21010600' or time == '21010900' or time == '21011700' or time == '21012000'):
            val0 = int(valueList[38]) + valueList[67]
            val1 = valueList[94]
            val2 = valueList[95]
            val3 = valueList[97]
            ...
            val2 = valueList[102]
            val3 = valueList[104]
        elif time == '20112800': # 2020.11.28 00시의 data 이면
            val0 = valueList[38] + valueList[67]
            val1 = valueList[88]
            val2 = valueList[89]
            val3 = valueList[91]
            ...
            val2 = valueList[113]
            val3 = valueList[115]
        elif time == '20112500' or time == '20121900' or time == '21011300' or time == '21012800':
            val0 = int(valueList[38]) + valueList[67]
            val1 = valueList[91]
            val2 = valueList[92]
            val3 = valueList[94]
            ...
            val2 = valueList[100]
            val3 = valueList[102]
        elif time == '20111900' or time == '21010200' or time == '21011500' or time == '21012600':
            val0 = valueList[38] + valueList[67]
            val1 = valueList[92]
            val2 = valueList[93]
            val3 = valueList[95]
            ...
            val2 = valueList[97]
            val3 = valueList[99]
        elif time == '20111100' or time == '20111800' or time == '20120100':
            val0 = valueList[38] + valueList[67]
            val1 = valueList[95]
            val2 = valueList[96]
            val3 = valueList[98]
            ...
            val2 = valueList[103]
            val3 = valueList[105]
        elif time == '20110500' or time == '20111200' or time == '20120300' or time == '20121700' or time == '20122000':
            val0 = int(valueList[38]) + valueList[67]
            val1 = valueList[93]
            val2 = valueList[94]
            val3 = valueList[96]
            ...
            val2 = valueList[96]
            val3 = valueList[98]
        elif time == '20103100' or time == '20110200' or time == '20110400' or time == '20110700' or time == '20110800' or time == '20111500' or time == '20112400':
            val0 = valueList[39] + valueList[70]
            val1 = valueList[97]
            val2 = valueList[98]
            val3 = valueList[100]
