...
for i in range(len(linkList)): # list.txt 파일에 있는 각 질병관리청 보도자료 링크에 있는 자료에 대하여 
    ...
    if int(time) >= 20072000: # 2020.07.20 00시 이후의 data 이면
        if time == '21031200': # 2021.03.12 00시의 data 이면
            ...
            val3 = valueList[93]
              ...
              time == '21021900' or time == '21022100' or time == '21022200' or time == '21031400'):
            val0 = int(valueList[38]) + valueList[67]
            val1 = valueList[94]
            val2 = valueList[95]
            val3 = valueList[97]
            ...
            val3 = valueList[98]
              ...
              time == '21021200' or time == '21021500' or time == '21030300' or time == '21030400' or time == '21031300'):
            val0 = int(valueList[38]) + valueList[67]
            val1 = valueList[93]
            val2 = valueList[94]
            val3 = valueList[96]
