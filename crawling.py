...
for i in range(len(linkList)): # list.txt 파일에 있는 각 질병관리본부 보도자료 링크에 있는 자료에 대하여 
    ...
    if int(time) >= 20072000: # 2020.07.20 00시 이후의 data 이면
        if time == '20082100': # 2020.08.21 00시의 data 이면
            val0 = valueList[39] + valueList[70]
            val1 = valueList[85]
            val2 = valueList[86]
            val3 = valueList[88]
        elif time == '20082000' or time == '20082200' or time == '20082300' or time == '20082400' or time == '20082500':
            val0 = valueList[39] + int(valueList[71])
            val1 = valueList[87]
            val2 = valueList[88]
            val3 = valueList[90]
        elif time == '20081200' or time == '20081300':
            val0 = valueList[39] + valueList[69]
            val1 = valueList[84]
            val2 = valueList[85]
            val3 = valueList[87]
        elif time == '20081100' or time == '20081400' or time == '20081900':
            ...
            val3 = valueList[88]
              ...
              time == '20080600' or time == '20080700' or time == '20081000' or time == '20082600' or time == '20082700' or time == '20082800'):
            val0 = valueList[38] + valueList[69]
            val1 = valueList[84]
            val2 = valueList[85]
            val3 = valueList[87]
