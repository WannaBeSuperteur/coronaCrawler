...
for i in range(len(linkList)): # list.txt 파일에 있는 각 질병관리본부 보도자료 링크에 있는 자료에 대하여 
    ...
    if int(time) >= 20072000: # 2020.07.20 00시 이후의 data 이면
        if time == '20111600': # 2020.11.16 00시의 data 이면
            val0 = valueList[39] + valueList[70]
            val1 = valueList[92]
            val2 = valueList[93]
            val3 = valueList[95]
        elif time == '20111300': # 2020.11.13 00시의 data 이면
            val0 = valueList[39] + valueList[70]
            val1 = valueList[96]
            val2 = valueList[97]
            val3 = valueList[99]
        elif time == '20111200': # 2020.11.12 00시의 data 이면
            val0 = valueList[38] + valueList[67]
            val1 = valueList[93]
            val2 = valueList[94]
            val3 = valueList[96]
        elif time == '20111100': # 2020.11.11 00시의 data 이면
            val0 = valueList[38] + valueList[67]
            val1 = valueList[95]
            val2 = valueList[96]
            val3 = valueList[98]
            ...
            val2 = valueList[103]
            val3 = valueList[105]
        elif time == '20110500': # 2020.11.05 00시의 data 이면
            val0 = valueList[38] + valueList[67]
            val1 = valueList[93]
            val2 = valueList[94]
            val3 = valueList[96]
            ...
            val2 = valueList[96]
            val3 = valueList[98]
        elif time == '20103100' or time == '20110200' or time == '20110400' or time == '20110700' or time == '20110800' or time == '20111500':
            val0 = valueList[39] + valueList[70]
            val1 = valueList[97]
            val2 = valueList[98]
            val3 = valueList[100]
            ...
            val3 = valueList[87]
              ...
              time == '20101200' or time == '20102800' or time == '20102900' or time == '20110100' or time == '20110600' or time == '20111400'):
            val0 = valueList[38] + valueList[67]
            val1 = valueList[82]
            val2 = valueList[83]
            val3 = valueList[85]
