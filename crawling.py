...
for i in range(len(linkList)): # list.txt 파일에 있는 각 질병관리본부 보도자료 링크에 있는 자료에 대하여 
    ...
    if int(time) >= 20072000: # 2020.07.20 00시 이후의 data 이면
        if time == '20123100': # 2020.12.31 00시의 data 이면
            ...
            val2 = valueList[102]
            val3 = valueList[104]
        elif time == '20120800' or time == '20121500' or time == '20122600' or time == '21010100':
            val0 = valueList[38] + valueList[67]
            val1 = valueList[95]
            val2 = valueList[96]
            val3 = valueList[98]
            ...
            val2 = valueList[100]
            val3 = valueList[102]
        elif time == '20111900': # 2020.11.19 00시의 data 이면
            val0 = valueList[38] + valueList[67]
            val1 = valueList[92]
            val2 = valueList[93]
            val3 = valueList[95]
