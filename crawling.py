...
for i in range(len(linkList)): # list.txt 파일에 있는 각 질병관리청 보도자료 링크에 있는 자료에 대하여 
    ...
    if int(time) >= 20072000: # 2020.07.20 00시 이후의 data 이면
        if time == '21010500': # 2021.01.05 00시의 data 이면
            ...
            val2 = valueList[96]
            val3 = valueList[98]
        elif time == '20120700' or time == '20120900' or time == '20121600' or time == '20123000' or time == '21010700' or time == '21010800':
            val0 = int(valueList[38]) + valueList[67]
            val1 = valueList[96]
            val2 = valueList[97]
            val3 = valueList[99]
            ...
            val2 = valueList[94]
            val3 = valueList[96]
        elif time == '20120400' or time == '20122700':
            val0 = valueList[38] + valueList[67]
            val1 = valueList[90]
            val2 = valueList[91]
            val3 = valueList[93]
        elif time == '20120200' or time == '20120600' or time == '20122100' or time == '20122300' or time == '20122800' or time == '21010600':
            val0 = int(valueList[38]) + valueList[67]
            val1 = valueList[94]
            val2 = valueList[95]
            val3 = valueList[97]
            ...
            val2 = valueList[100]
            val3 = valueList[102]
        elif time == '20111900' or time == '21010200':
            val0 = valueList[38] + valueList[67]
            val1 = valueList[92]
            val2 = valueList[93]
            val3 = valueList[95]
