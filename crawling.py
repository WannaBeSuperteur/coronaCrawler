...
for i in range(len(linkList)): # list.txt 파일에 있는 각 질병관리청 보도자료 링크에 있는 자료에 대하여 
    ...
    if int(time) >= 20072000: # 2020.07.20 00시 이후의 data 이면
        if time == '21020700': # 2021.02.07 00시의 data 이면
            ...
            val2 = valueList[99]
            val3 = valueList[101]
        elif time == '21011400' or time == '21011600' or time == '21012700' or time == '21013100' or time == '21020200' or time == '21020600' or time == '21021800':
            val0 = int(valueList[38]) + valueList[67]
            val1 = valueList[97]
            val2 = valueList[98]
            val3 = valueList[100]
            ...
            val3 = valueList[93]
              ...
              time == '21010600' or time == '21010900' or time == '21011700' or time == '21012000' or time == '21021100' or time == '21021900'):
            val0 = int(valueList[38]) + valueList[67]
            val1 = valueList[94]
            val2 = valueList[95]
            val3 = valueList[97]
