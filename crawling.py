    ...
    if int(time) >= 20072000: # 2020.07.20 00시 이후의 data 이면
        if time == '21031200': # 2021.03.12 00시의 data 이면
            ...
            val3 = valueList[98]
              ...
              time == '21020500' or time == '21021600' or time == '21022300' or time == '21031600'):
            val0 = int(valueList[38]) + valueList[67]
            val1 = valueList[96]
            val2 = valueList[97]
            val3 = valueList[99]
            ...
            val2 = valueList[100]
            val3 = valueList[102]
        elif time == '20111900' or time == '21010200' or time == '21011500' or time == '21012600' or time == '21030600' or time == '21031700':
            val0 = valueList[38] + valueList[67]
            val1 = valueList[92]
            val2 = valueList[93]
            val3 = valueList[95]
