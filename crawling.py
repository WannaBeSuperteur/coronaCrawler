...
for i in range(len(linkList)): # list.txt 파일에 있는 각 질병관리본부 보도자료 링크에 있는 자료에 대하여 
    ...
    if int(time) >= 20072000: # 2020.07.20 00시 이후의 data 이면
        if time == '20090600': # 2020.09.06 00시의 data 이면
            val0 = valueList[39] + valueList[72]
            val1 = valueList[88]
            val2 = valueList[89]
            val3 = valueList[91]
        elif time == '20090200': # 2020.09.02 00시의 data 이면
            ...
            val3 = valueList[88]
              ...
              time == '20083000' or time == '20083100' or time == '20090300' or time == '20090400' or time == '20090500' or time == '20090700'):
