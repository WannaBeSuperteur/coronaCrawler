...
for i in range(len(linkList)): # list.txt 파일에 있는 각 질병관리청 보도자료 링크에 있는 자료에 대하여
    ...
    if int(time) >= 20072000: # 2020.07.20 00시 이후의 data 이면
        if time == '21033000': # 2021.03.30 00시의 data 이면
            ...
            val3 = valueList[101]
              ...
              time == '21020600' or time == '21021800' or time == '21022500' or time == '21022800' or time == '21032100'):
            val0 = int(valueList[38]) + valueList[67]
            val1 = valueList[97]
            val2 = valueList[98]
            val3 = valueList[100]
            ...
            val2 = valueList[102]
            val3 = valueList[104]
        elif time == '20120800' or time == '20121500' or time == '20122600' or time == '21010100' or time == '21010400' or time == '21022400' or time == '21032400':
            val0 = valueList[38] + valueList[67]
            val1 = valueList[95]
            val2 = valueList[96]
            val3 = valueList[98]
              ...
              time == '21020500' or time == '21021600' or time == '21022300' or time == '21031600' or time == '21031900'):
            val0 = int(valueList[38]) + valueList[67]
            val1 = valueList[96]
            val2 = valueList[97]
            val3 = valueList[99]
            ...
            val3 = valueList[93]
              ...
              time == '21021900' or time == '21022100' or time == '21022200' or time == '21031400' or time == '21032200'):
            val0 = int(valueList[38]) + valueList[67]
            val1 = valueList[94]
            val2 = valueList[95]
            val3 = valueList[97]
            ...
            val2 = valueList[113]
            val3 = valueList[115]
        elif time == '20112500' or time == '20121900' or time == '21011300' or time == '21012800' or time == '21021300' or time == '21032600':
            val0 = int(valueList[38]) + valueList[67]
            val1 = valueList[91]
            val2 = valueList[92]
            val3 = valueList[94]
            ...
            val3 = valueList[102]
              ...
              time == '21031700' or time == '21032000' or time == '21032300'):
            val0 = valueList[38] + valueList[67]
            val1 = valueList[92]
            val2 = valueList[93]
            val3 = valueList[95]
            ...
            val3 = valueList[98]
              ...
              time == '21031800' or time == '21032700' or time == '21032800' or time == '21032900' or time == '21033100'):
            val0 = int(valueList[38]) + valueList[67]
            val1 = valueList[93]
            val2 = valueList[94]
            val3 = valueList[96]
