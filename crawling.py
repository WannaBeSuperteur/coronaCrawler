...
for i in range(len(linkList)): # list.txt 파일에 있는 각 질병관리본부 보도자료 링크에 있는 자료에 대하여 
    ...
    if int(time) >= 20072000: # 2020.07.20 00시 이후의 data 이면
        if time == '20091000': # 2020.09.10 00시의 data 이면
            ...
            val2 = valueList[83]
            val3 = valueList[85]
        elif time == '20082100' or time == '20083000' or time == '20083100' or time == '20090100' or time == '20091200' or time == '20091400' or time == '20091500':
            val0 = valueList[39] + valueList[70]
            val1 = valueList[85]
            val2 = valueList[86]
            val3 = valueList[88]
        elif (time == '20082000' or time == '20082200' or time == '20082300' or time == '20082400' or time == '20082500' or
              time == '20083000' or time == '20083100' or time == '20090300' or time == '20090400' or time == '20090500' or time == '20090700' or time == '20091300'):
