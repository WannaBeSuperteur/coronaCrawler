...
for i in range(len(linkList)): # list.txt 파일에 있는 각 질병관리본부 보도자료 링크에 있는 자료에 대하여 
    ...
    if int(time) >= 20030600: # 2020.03.06 00시 이후의 data이면
        ...
        elif time == '20041900' or time == '20042400' or time == '20042500' or time == '20042600' or time == '20050800' or time == '20050900' or time == '20051000':
        ...
        # 63~80열: 지역별 합계    (순서: 전국 서울 부산 대구 인천 광주 대전 울산 세종 경기 강원 충북 충남 전북 전남 경북 경남 제주)
        #                 (=격리중+격리해제+사망자수)
        if time == '20041900' or time == '20042400' or time == '20042500' or time == '20042600' or time == '20050800' or time == '20050900' or time == '20051000':
