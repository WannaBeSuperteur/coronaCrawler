...
for i in range(len(linkList)): # list.txt 파일에 있는 각 질병관리본부 보도자료 링크에 있는 자료에 대하여 
    ...
    if int(time) >= 20072000: # 2020.07.20 00시 이후의 data 이면
        if time == '20121100': # 2020.12.11 00시의 data 이면
            ...
            val2 = valueList[102]
            val3 = valueList[104]
        elif time == '20120800': # 2020.12.08 00시의 data 이면
            val0 = valueList[38] + valueList[67]
            val1 = valueList[95]
            val2 = valueList[96]
            val3 = valueList[98]
        elif time == '20120700' or time == '20120900':
            val0 = valueList[38] + valueList[67]
            val1 = valueList[96]
            val2 = valueList[97]
            val3 = valueList[99]
        elif time == '20120500': # 2020.12.05 00시의 data 이면
            val0 = valueList[38] + valueList[68]
            val1 = valueList[93]
            val2 = valueList[94]
            val3 = valueList[96]
        elif time == '20120400': # 2020.12.04 00시의 data 이면
            val0 = valueList[38] + valueList[67]
            val1 = valueList[90]
            val2 = valueList[91]
            val3 = valueList[93]
        elif time == '20120200' or time == '20120600':
            val0 = valueList[38] + valueList[67]
            val1 = valueList[94]
            val2 = valueList[95]
            val3 = valueList[97]
            ...
            val2 = 0
            val3 = 0
        elif time == '20112900': # 2020.11.29 00시의 data 이면
            val0 = valueList[38] + valueList[68]
            val1 = valueList[101]
            val2 = valueList[102]
            val3 = valueList[104]
            ...
            val2 = valueList[103]
            val3 = valueList[105]
        elif time == '20110500' or time == '20111200' or time == '20120300':
            val0 = valueList[38] + valueList[67]
            val1 = valueList[93]
            val2 = valueList[94]
            val3 = valueList[96]
            ...
            val3 = valueList[87]
              ...
              time == '20101200' or time == '20102800' or time == '20102900' or time == '20110100' or time == '20110600' or time == '20111400' or time == '20112100'):
            val0 = valueList[38] + valueList[67]
            val1 = valueList[82]
            val2 = valueList[83]
            val3 = valueList[85]
