...
for i in range(len(linkList)): # list.txt 파일에 있는 각 질병관리청 보도자료 링크에 있는 자료에 대하여 
    ...
    if int(time) >= 20072000: # 2020.07.20 00시 이후의 data 이면
        if time == '21012200': # 2021.01.22 00시의 data 이면
            ...
            val2 = valueList[99]
            val3 = valueList[101]
        elif time == '21011400' or time == '21011600' or time == '21012700' or time == '21013100' or time == '21020200':
            val0 = int(valueList[38]) + valueList[67]
            val1 = valueList[97]
            val2 = valueList[98]
            val3 = valueList[100]
            ...
            val3 = valueList[98]
              ...
              time == '21010800' or time == '21011100' or time == '21011800' or time == '21011900' or time == '21020300'):
            val0 = int(valueList[38]) + valueList[67]
            val1 = valueList[96]
            val2 = valueList[97]
            val3 = valueList[99]
            ...
            val2 = valueList[94]
            val3 = valueList[96]
        elif time == '20120400' or time == '20122700' or time == '21011200' or time == '21012400' or time == '21012900' or time == '21020400':
            val0 = valueList[38] + valueList[67]
            val1 = valueList[90]
            val2 = valueList[91]
            val3 = valueList[93]
