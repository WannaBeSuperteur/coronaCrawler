...
for i in range(len(linkList)): # list.txt 파일에 있는 각 질병관리본부 보도자료 링크에 있는 자료에 대하여 
    ...
    if int(time) >= 20072000: # 2020.07.20 00시 이후의 data 이면
        if time == '20093000': # 2020.09.30 00시의 data 이면
            ...
            val2 = valueList[85]
            val3 = valueList[87]
        elif time == '20082800' or time == '20082900' or time == '20100200':
            ...
            val3 = valueList[85]
              ...
              time == '20092900' or time == '20100100' or time == '20100300' or time == '20100400' or time == '20100500' or time == '20100600' or time == '20100700'):
            val0 = valueList[39] + valueList[70]
            val1 = valueList[85]
            val2 = valueList[86]
            val3 = valueList[88]
