...
for i in range(len(linkList)): # list.txt 파일에 있는 각 질병관리청 보도자료 링크에 있는 자료에 대하여 
    ...
    if int(time) >= 20072000: # 2020.07.20 00시 이후의 data 이면
        if time == '21020700': # 2021.02.07 00시의 data 이면
            ...
            val2 = valueList[94]
            val3 = valueList[96]
        elif time == '21012100' or time == '21012300' or time == '21012500' or time == '21020800' or time == '21021400':
            val0 = int(valueList[38]) + valueList[67]
            val1 = valueList[98]
            val2 = valueList[99]
            val3 = valueList[101]
            ...
            val2 = valueList[106]
            val3 = valueList[108]
        elif time == '21010500' or time == '21013000' or time == '21021000':
            ...
            val2 = valueList[90]
            val3 = valueList[92]
        elif time == '20121100' or time == '20122200' or time == '21020900':
            val0 = int(valueList[38]) + valueList[67]
            val1 = valueList[99]
            val2 = valueList[100]
            val3 = valueList[102]
            ...
            val3 = valueList[93]
              ...
              time == '21010600' or time == '21010900' or time == '21011700' or time == '21012000' or time == '21021100'):
            val0 = int(valueList[38]) + valueList[67]
            val1 = valueList[94]
            val2 = valueList[95]
            val3 = valueList[97]
            ...
            val2 = valueList[113]
            val3 = valueList[115]
        elif time == '20112500' or time == '20121900' or time == '21011300' or time == '21012800' or time == '21021300':
            val0 = int(valueList[38]) + valueList[67]
            val1 = valueList[91]
            val2 = valueList[92]
            val3 = valueList[94]
            ...
            val2 = valueList[103]
            val3 = valueList[105]
        elif time == '20110500' or time == '20111200' or time == '20120300' or time == '20121700' or time == '20122000' or time == '21021200':
            val0 = int(valueList[38]) + valueList[67]
            val1 = valueList[93]
            val2 = valueList[94]
            val3 = valueList[96]
