...
for i in range(len(linkList)): # list.txt 파일에 있는 각 질병관리청 보도자료 링크에 있는 자료에 대하여
    ...
    if int(time) >= 20072000: # 2020.07.20 00시 이후의 data 이면
        if time == '21102000': # 2021.10.20 00시의 data 이면
            val0 = valueList[241] + valueList[270]
            val1 = valueList[294]
            val2 = valueList[295]
            val3 = valueList[297]
        elif time == '21101900': # 2021.10.19 00시의 data 이면
            ...
            val2 = valueList[180]
            val3 = valueList[182]
        elif time == '21101600': # 2021.10.16 00시의 data 이면
            ...
            val2 = valueList[294]
            val3 = valueList[296]
        elif time == '21100300': # 2021.10.03 00시의 data 이면
            val0 = valueList[89] + valueList[118]
            val1 = valueList[145]
            val2 = valueList[146]
            val3 = valueList[148]
            ...
            val2 = valueList[300]
            val3 = valueList[302]
        elif time == '21092600': # 2021.09.26 00시의 data 이면
            val0 = valueList[89] + valueList[118]
            val1 = valueList[148]
            val2 = valueList[149]
            val3 = valueList[151]
